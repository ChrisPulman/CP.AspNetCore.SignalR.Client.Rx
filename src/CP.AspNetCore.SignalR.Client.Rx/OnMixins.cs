...
public static class OnMixins
{
    ...
    extension(HubConnection connection)
    {
        ...
        public IObservable<Unit> On(string methodName) =>
        ...
        public IObservable<(T1 t1, T2 t2)> On<T1, T2>(string methodName) =>
            Observable.Create<(T1 t1, T2 t2)>(observer =>
            {
        ...
        public IObservable<(T1 t1, T2 t2, T3 t3)> On<T1, T2, T3>(string methodName) =>
            Observable.Create<(T1 t1, T2 t2, T3 t3)>(observer =>
            {
        ...
        public IObservable<(T1 t1, T2 t2, T3 t3, T4 t4)> On<T1, T2, T3, T4>(string methodName) =>
            Observable.Create<(T1 t1, T2 t2, T3 t3, T4 t4)>(observer =>
            {
        ...
        public IObservable<(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)> On<T1, T2, T3, T4, T5>(string methodName) =>
            Observable.Create<(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)>(observer =>
            {
        ...
        public IObservable<(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6)> On<T1, T2, T3, T4, T5, T6>(string methodName) =>
            Observable.Create<(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6)>(observer =>
            {
        ...
        public IObservable<(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7)> On<T1, T2, T3, T4, T5, T6, T7>(string methodName) =>
            Observable.Create<(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7)>(observer =>
            {
        ...
        public IObservable<(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8)> On<T1, T2, T3, T4, T5, T6, T7, T8>(string methodName) =>
            Observable.Create<(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8)>(observer =>
            {
